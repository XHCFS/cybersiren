// svc-08-decision entrypoint — aggregates risk signals from all analysis
// services, applies rules, and writes a final verdict for each email.
package main
...
func main() {
	...
	tracerShutdown, err := tracing.Init(ctx, "svc-08-decision", cfg.JaegerEndpoint)
	if err != nil {
	...
	reg := metrics.Init("svc-08-decision")
	...
	log.Info().
		...
		Msg("svc-08-decision started")

	// TODO: consume aggregated scores from svc-07-aggregator
	// TODO: apply typosquatting detection and domain reputation rules
	// TODO: write final verdict for each email
	// TODO: emit verdict events for svc-09-notification

// svc-10-api-dashboard entrypoint — serves the REST API and web dashboard
// for viewing verdicts, managing rules, and monitoring the pipeline.
package main
...
func main() {
	...
	tracerShutdown, err := tracing.Init(ctx, "svc-10-api-dashboard", cfg.JaegerEndpoint)
	if err != nil {
	...
	reg := metrics.Init("svc-10-api-dashboard")
	...
	log.Info().
		...
		Msg("svc-10-api-dashboard started")

	// TODO: initialize database connection pool
	// TODO: register REST API routes (verdicts, rules, dashboard data)
	// TODO: serve the React web dashboard static files
	// TODO: start the main HTTP server
